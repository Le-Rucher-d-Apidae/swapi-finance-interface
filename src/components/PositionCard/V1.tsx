...
import { Token, TokenAmount, WMATIC, CURRENCY } from '@swapi-finance/sdk-local'
        ...
        <FixedHeightRow>
          <RowFixed>
            ...
            <Text fontWeight={500} fontSize={20} style={{ marginLeft: '' }}>
              ...
              {`${chainId && token.equals(WMATIC[chainId]) ? WMATIC[chainId].name : token.symbol}/${CURRENCY.symbol}`}
            </Text>
            <Text
              fontSize={12}
              fontWeight={500}
